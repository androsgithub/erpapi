...
create table
   tb_tenant (
      id bigint not null auto_increment,
      ativa bit not null,
      businesspartner_audit_enabled bit not null,
      businesspartner_cache_enabled bit not null,
      businesspartner_notification_enabled bit not null,
      businesspartner_tenant_customization_enabled bit not null,
      businesspartner_validation_enabled bit not null,
