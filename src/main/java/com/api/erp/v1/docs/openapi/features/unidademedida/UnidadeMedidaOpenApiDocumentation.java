package com.api.erp.v1.docs.openapi.features.unidademedida;
...
public interface UnidadeMedidaOpenApiDocumentation extends IUnidadeMedidaController {
    ...
    ResponseEntity<UnidadeMedidaResponseDTO> criar(UnidadeMedidaRequestDTO dto);
