package com.api.erp.v1.docs.openapi.features.usuario;
...
/**
 * Interface de documentação OpenAPI para Usuario.
 */
@Tag(name = "Usuários", description = "Gestão de usuários do sistema")
public interface UsuarioOpenApiDocumentation extends IUsuarioController {
