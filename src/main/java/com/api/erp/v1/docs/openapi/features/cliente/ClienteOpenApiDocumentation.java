package com.api.erp.v1.docs.openapi.features.cliente;
...
/**
 * Interface de documentação OpenAPI para Cliente.
 */
@Tag(
        name = "Clientes",
        description = "Endpoints responsáveis pela gestão de clientes da empresa"
)
public interface ClienteOpenApiDocumentation extends IClienteController {
