...
/**
 * Interface de documentação OpenAPI para Address.
 */
@Tag(name = "Endereços", description = "Gestão de Endereços")
public interface AddressOpenApiDocumentation extends IAddressController {
    ...
    ResponseEntity<List<AddressResponse>> listar();
