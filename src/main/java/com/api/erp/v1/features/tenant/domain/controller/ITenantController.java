...
public interface ITenantController {
    ...
    ResponseEntity<TenantResponse> obter(Long tenantId);
    ...
    @Operation(
            ...
            description = "Deleta uma tenant (inativa) do sistema e seus dados associados."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Tenant deletada com sucesso"),
            @ApiResponse(responseCode = "404", description = "Tenant não encontrada"),
            @ApiResponse(responseCode = "401", description = "Usuário não autenticado")
    })
    ResponseEntity<Void> deletar(Long tenantId);
