...
public interface ContatoRepository extends JpaRepository<Contato, Long> {
     ...
     */
    List<Contato> findByTipoAndAtivoTrue(com.api.erp.v1.features.contato.domain.entity.TipoContato tipo);
     ...
     */
    List<Contato> findByValorAndTipo(@Param("valor") String valor, @Param("tipo") com.api.erp.v1.features.contato.domain.entity.TipoContato tipo);
}
