...
@EnableJpaRepositories(
        basePackages = {
                "com.api.erp.v1.main.master.tenant.domain.repository",
                "com.api.erp.v1.main.master.user.domain.repository",
                "com.api.erp.v1.main.master.permission.domain.repository"
        },
...
public class MasterJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory(
        ...
        return builder
                ...
                .packages(
                        "com.api.erp.v1.main.master.tenant.domain.entity",
                        "com.api.erp.v1.main.master.user.domain.entity",
                        "com.api.erp.v1.main.master.permission.domain.entity",
