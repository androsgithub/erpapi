package com.api.erp.v1.main.features.endereco.domain.entity;

public final class EnderecoPermissions {

    private EnderecoPermissions() {
    }

    public static final String PREFIX = "enderecos";
