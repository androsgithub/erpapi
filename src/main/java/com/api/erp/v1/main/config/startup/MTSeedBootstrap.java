...
@Component
@Slf4j
public class MTSeedBootstrap {

    private final TenantRepository tenantRepository;
    private final MainSeed mainSeed;

    @Value("${dros.erpapi.bootstrap.schema:false}")
    private boolean bootstrapSchemas;

    @Autowired
    public MTSeedBootstrap(TenantRepository tenantRepository, MainSeed mainSeed) {
