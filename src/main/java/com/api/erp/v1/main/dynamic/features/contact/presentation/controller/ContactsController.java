package com.api.erp.v1.main.dynamic.features.contact.presentation.controller;
...
public class ContactsController implements IContactsController, ContactsOpenApiDocumentation {
    ...
    public ResponseEntity<Set<ContactResponse>> listar() {
        ...
        return ResponseEntity.ok(contactMapper.toResponse(contacts));
    }
    ...
    @RequiresXTenantId
    @RequiresPermission(ContactPermissions.VIEW)
    public ResponseEntity<Set<ContactResponse>> listarPorTipo(
