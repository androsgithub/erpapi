package com.api.erp.v1.main.master.permission.infrastructure.decorator;
...
public class PermissionAuditServiceDecorator implements IPermissionService {
    ...
    public boolean hasPermission(Long userId, String permissionCodigo) {
        log.info("Audit: Checking access for user {} on permission '{}'",
                userId, permissionCodigo);

        boolean result = delegate.hasPermission(userId, permissionCodigo);
