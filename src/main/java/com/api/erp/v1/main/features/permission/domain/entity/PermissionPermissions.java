...
/**
 * Permission-specific permission constants.
 * <p>
 * Defines all permissions related to Permission management.
 * Uses BasePermissions for standard operations.
 */
public final class PermissionPermissions {

    private PermissionPermissions() {
    }
