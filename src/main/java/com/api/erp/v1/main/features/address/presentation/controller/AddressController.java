...
public class AddressController implements IAddressController, AddressOpenApiDocumentation {
    ...
    @PostMapping
    @RequiresXTenantId
    @RequiresPermission(AddressPermissions.CRIAR)
    ...
    @GetMapping("/{id}")
    @RequiresXTenantId
    @RequiresPermission(AddressPermissions.VISUALIZAR)
    ...
    @PutMapping("/{id}")
    @RequiresXTenantId
    @RequiresPermission(AddressPermissions.ATUALIZAR)
    ...
    @DeleteMapping("/{id}")
    @RequiresXTenantId
    @RequiresPermission(AddressPermissions.DELETAR)
