...
@EnableJpaRepositories(
        basePackages = {
                "com.api.erp.v1.main.features.endereco.domain.repository",
                "com.api.erp.v1.main.features.cliente.domain.repository",
                "com.api.erp.v1.main.features.contato.domain.repository",
                "com.api.erp.v1.main.features.usuario.domain.repository",
                "com.api.erp.v1.main.features.permissao.domain.repository",
                "com.api.erp.v1.main.features.produto.domain.repository",
                "com.api.erp.v1.main.features.customfield.domain.repository",
                "com.api.erp.v1.main.features.unidademedida.domain.repository"
        },
