package com.api.erp.v1.shared.presentation.controller;

import com.api.erp.v1.shared.infrastructure.config.TenantMigrationService;
 ...
 * 
 * Endpoints:
 * - POST /api/v1/admin/migrations/tenants - Executa migrações em todos os tenants
 * - POST /api/v1/admin/migrations/tenants/{tenantId} - Executa migração em um tenant específico
 * 
