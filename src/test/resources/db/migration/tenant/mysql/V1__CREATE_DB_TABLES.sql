...
create table
   TB_BUSINESSPARTNER_CONTACT (
      businesspartner_id bigint not null,
      contact_id bigint not null
   ) engine = InnoDB;

create table
   TB_BUSINESSPARTNER_ADDRESS (
      businesspartner_id bigint not null,
...
alter table TB_BUSINESSPARTNER_CONTACT add constraint UKoyvoyiovpks7mak7a6o9shsjf unique (contact_id);

alter table TB_BUSINESSPARTNER_ADDRESS add constraint UK3g4mi2jwv887g1adobbi2ty7j unique (address_id);
...
alter table TB_BUSINESSPARTNER_CONTACT add constraint FKar3q0fwokcc43i1w07alv1u9t foreign key (contact_id) references tb_contacts (id);

alter table TB_BUSINESSPARTNER_CONTACT add constraint FKf44b9l0vsi0mdpwwwla1sfx27 foreign key (businesspartner_id) references tb_business_partner (id);

alter table TB_BUSINESSPARTNER_ADDRESS add constraint FKh4pilbdgv2i62kt67lignqxat foreign key (address_id) references tb_address (id);

alter table TB_BUSINESSPARTNER_ADDRESS add constraint FKe9hd85a57v19b97k79s98yqr8 foreign key (businesspartner_id) references tb_business_partner (id);
